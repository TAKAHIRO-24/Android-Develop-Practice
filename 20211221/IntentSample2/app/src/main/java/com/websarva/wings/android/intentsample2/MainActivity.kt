...
class MainActivity : AppCompatActivity() {
    ...
    //SimpleAdapter作成
    private fun createSimpleAdapter() : Unit {
        //画面部品ListViewを取得
        val lvMenu = findViewById<ListView>(R.id.lvMenu)

        //メニューリストに登録
        val menuList: MutableList<MutableMap<String, String>> = setMenuList()
        //SimpleAdapterを生成
    ...
    //メニューリストに追加
    private fun setMenuList() : MutableList<MutableMap<String, String>> {
